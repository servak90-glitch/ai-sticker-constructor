...
export const STYLE_LIBRARY: StyleLibrary = {
    ...
    'NEO_POP': { 
     ...
     'VIBRANT_DIGITAL_COMIC': {
        ...
        strictPrompt: "Цифровой комикс-иллюстрация в стиле яркого плаката. Используй триадную цветовую гармонию: ярко-желтый (#FFFF00), бирюзовый (#00CED1) или оранжево-красный (#FF4500) фоны, глубокий сине-серый (#2E4053) для основных объектов, оранжево-красные (#FF4500) акценты. Все контуры должны быть четкими, черными, постоянной толщины. Штриховка и хатчура для текстуры, особенно на органических формах. Матовая поверхность, высокий контраст, никаких полутонов. Плоская композиция, фронтальное освещение. Яркая, энергичная, веселая энергия.",
        artisticPrompt: "Создай современную цифровую иллюстрацию с энергией комиксного плаката. Используй сочные, неоновые цвета — желтые, голубые или оранжево-красные фоны контрастируют с темными объектами. Четкие черные линии определяют каждую форму. Добавь органичную штриховку для текстуры и выразительности. Настроение должно быть оптимистичным и немного ироничным, как в поп-арте. Детали подчеркнуты, композиция плоская и графичная.",
...
export const NEGATIVE_PROMPTS: Record<string, string> = {
    ...
    VIBRANT_DIGITAL_COMIC: "мягкие размытые края, пастельные или приглушенные цвета, реалистичное затенение и трехмерность, сложная перспектива, минималистичный дизайн, тонких линий, водных эффектов или прозрачности, натуральных текстур (камень, дерево), кинематографического освещения, высокодетализированного фона, полутонов и градиентов, мягких переходов между цветами, бледных или ненасыщенных оттенков",
};